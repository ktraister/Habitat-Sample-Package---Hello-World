...
/* This file is intended to build, test, and deploy to production an application housed in a single git repo
 * This pipeline should be triggered by starting the Jenkins job when ready for deployment
 *
 */
...
pipeline {
	...
	stage('test') {
		 ...
		 //To keep space usage down, we're destroying the image and container after use
		 sh """
		    #!/bin/bash
